...
export function dijkstraActions(adj, startId, finishId, nodeIds) {
    ...
    if (hasNeg) actions.push({ type: 'status', text: 'Dijkstra 假定权重非负' });
